...
class Dongle extends EventEmitter {
  ...
  constructor(peripheral, options) {
    ...
    this.uuidStatus = [
      '6765ed1f4de149e14771a14380c90006', // 1
      '6765ed1f4de149e14771a14380c90007', // 2
      '6765ed1f4de149e14771a14380c90008', // 3
      '6765ed1f4de149e14771a14380c90009', // 4
      '6765ed1f4de149e14771a14380c9000a', // 5
      '6765ed1f4de149e14771a14380c9000b', // 6
      '6765ed1f4de149e14771a14380c9000c', // 7
      '6765ed1f4de149e14771a14380c9000d', // 8
      '6765ed1f4de149e14771a14380c9000e', // 9
      '6765ed1f4de149e14771a14380c9000f', // 10

      '6765ed1f4de149e14771a14380c90010', // 11
      '6765ed1f4de149e14771a14380c90011', // 12
      '6765ed1f4de149e14771a14380c90012', // 13
      '6765ed1f4de149e14771a14380c90013', // 14
      '6765ed1f4de149e14771a14380c90014', // 15
      '6765ed1f4de149e14771a14380c90015', // 16
      '6765ed1f4de149e14771a14380c90016', // 17
      '6765ed1f4de149e14771a14380c90017', // 18
      '6765ed1f4de149e14771a14380c90018', // 19
      '6765ed1f4de149e14771a14380c90019', // 20

      '6765ed1f4de149e14771a14380c9001a', // 21
      '6765ed1f4de149e14771a14380c9001b', // 22
      '6765ed1f4de149e14771a14380c9001c', // 23
      '6765ed1f4de149e14771a14380c9001d', // 24
      '6765ed1f4de149e14771a14380c9001e', // 25
    ];   
    this.numStatus = this.uuidStatus.length;

    this.uuidSuperwatcher = '6765ed1f4de149e14771a14380c900ff';
  ...
  // Write to device memory using the MODBUS write memory with verification function code
  // returns a Promise that resolves when the write is complete
  writeMemoryVerify(dest, address, data, options) {
  ...
  superwatch(id, addresses, cb) {
    ...
    return me.command(me.id, OP_SUPERWATCH, Buffer.from(commandArray))
    .then(() => {
      me.subscribe(me.superwatcherChar)
    });
  ...
  async getWatchers() {
    ...
    return this.command(this.id, OP_GET_WATCHER, Buffer.from([GET_WATCHERS]))
    .then((response) => {
  ...
  async getSuperWatcher() {
    let superWatcherMembers = [];

    return this.command(this.id, OP_GET_WATCHER, Buffer.from([GET_SUPERWATCHER]))
    .then((response) => {
  ...
  async clearSuperWatcher() {
      
    let me = this;

    return me.unsubscribe(me.superwatcherChar)
    .then(() => {
      me.command(me.id, OP_UNWATCH, Buffer.from([0xFF]));
    });
  ...
  unwatch(slot) {
    ...
    } else if (slot == SLOT_SUPERWATCH) {
      // Super-watcher
      console.log("unwatch: superwatcher");
      return me.clearSuperWatcher();
    } else {
  ...
  unwatchAll(slot) {
    ...
    // Unsubscribe from the watchers
    for (let i = 0; i < this.numStatus; i++) {
      this.unsubscribe(this.statusChar[i]);
    }

    // Unsubscribe from the super-watcher
    if (this.superwatcherChar) {
      this.unsubscribe(this.superwatcherChar);
    }
  ...
  writeCharacteristic(characteristic, value) {
    ...
    return new Promise(function(resolve, reject) {
      ...
      if (me.isConnected()) {
        ...
        characteristic.write(value, false, function(err) {
          if (err) {
            reject(err);
          } else {
            resolve();
      ...
      me.peripheral.discoverSomeServicesAndCharacteristics(
        ...
        function(err, services, characteristics) {
          ...
          if (err) {
            ...
            me.superwatcherChar = _.findWhere(characteristics, { uuid: me.uuidSuperwatcher });
            ...
            if (
              ...
              .then(function() {
                ...
                if (me.superwatcherChar) {
                  me.superwatchCb = null;
                  me.superwatcherChar.on('data', me.onStatus.bind(me, 0xFF));
                }
  ...
  async writeAccessKey(key) {
    ...
    await this.writeObject(this.id, OBJECT_INFO, Buffer.from(key));
